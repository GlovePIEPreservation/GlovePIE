...
Version 0.45 (31 December 2011) Free Version
Copyright (c) Carl Kenner 2004-2011
=================================
...
This is a free version of GlovePIE. It does not support VR920, Playstation Move, Playstation Navigation subcontrollers,
Emotiv Epoc, 5DT Gloves, or Flock of Birds. It does not emulate XBox 360 controllers.  

If a commercial version is made later, it will not support the Microsoft Kinect SDK.

=================================
Copyright

GlovePIE is Copyright 2011 by Carl Kenner, except for the scripts by other authors. By using this software you agree to obey the following license conditions:
...
* NaturalPoint, or anyone or anything acting on their behalf, may not decompile, disassemble, view in a hex editor, reverse engineer, or study in any way any part of this software.
...
DirectX 9 or above (DX9 is included in Windows Vista and most games)
...
PPJoy (for emulating the joysticks, you may have problems with 64 bit OSes)
...
If you want speech recognition (recommended):
  ...
  Vista/Windows 7 contain the latest versions of the Recogniser.
  If you have Microsoft Office 2003 then you have Recogniser 6.1.
