...
Version 0.40 (31 December 2009)
Copyright (c) Carl Kenner 2004-2009
=================================
...
GlovePIE is Copyright 2009 by Carl Kenner, except for the scripts by other authors. By using this software you agree to obey the following license conditions:
...
A Bluetooth Stack, such as Bluesoleil (which doesn't work on vista), if you use Bluetooth
...
* Emotiv Epoc SDK version support (in theory)
